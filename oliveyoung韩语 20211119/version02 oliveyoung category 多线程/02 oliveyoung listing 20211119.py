...
html_data_start = get_response(url_start)


# 解析html代码，获取主要分类名称和编码
selector_start = parsel.Selector(html_data_start)
category2_names = selector_start.xpath('//*[@id="gnbAllMenu"]/ul/li[1]/div/ul/li/a/text()').getall()
category2_codes = selector_start.xpath('//*[@id="gnbAllMenu"]/ul/li[1]/div/ul/li/a[@data-ref-dispcatno]/@data-ref-dispcatno').getall()
...
for category2_name, category2_code in zip(category2_names,category2_codes):
    ...
    # 发送请求
    html_data_category_2 = get_response(url_category_2)
    ...
    for category3_name, category3_code in zip(category3_names, category3_codes):
        ...
        # 发送请求
        html_data_category_3 = get_response(url_category_3)
