...
for page in range(1, 2):
    ...
    url = f'https://www.oliveyoung.co.kr/store/display/getMCategoryList.do?dispCatNo=1000001000200060003&fltDispCatNo=&prdSort=03&pageIdx={page}&rowsPerPage={rowsPerPage}&searchTypeSort=btn_thumb&plusButtonFlag=N&isLoginCnt=0&aShowCnt=0&bShowCnt=0&cShowCnt=0&trackingCd=Cat1000001000200060003_Small'
    headers = {
    ...
    for d_url in urls:
        ...
        print(d_url, category, pageno, number, prd_name_mumber)
