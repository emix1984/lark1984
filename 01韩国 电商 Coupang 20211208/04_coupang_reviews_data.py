...
for page_review in range(8, page_review+1):
    page_review=page_review+1
    url_dp_review = f'https://www.coupang.com/vp/product/reviews?productId={productId}&page={page_review}&size={review_page_size}&sortBy={sortBy_review}&ratings={ratings_review}&q=&viRoleCode=2&ratingSummary=true'
    headers = {
    ...
    for n_article in range(1, review_page_size+1):
        ...
        if reviewer_id is None:
            ...
            print(productId, review_1, review_2, review_3, review_4, review_5, review_img_lis, url_dp_review)
